...
<body>
    ...
    <div class="container-grid">
        <div class="row">
            <div class="col col-sm-3 navy" > 
    <h1 class= " text-white borderr" name="name"  > <%= request.getAttribute("name")%></h1>
    <h5 class="text-white font-weight-normal borderr" name="designation"> <%= request.getAttribute("designation")%></h5>
    <div class="spam ">
        <h5 class="text-white ">Personal Information </h5>

    </div>
    <div class="shead text-white font-weight-bold" >Address </div>
    <div class="shead text-white"  name="address"><%= request.getAttribute("address")%></div>
    <div class="shead text-white font-weight-bold">Phone </div> 
    <div class="shead text-white"name="phone"><%= request.getAttribute("phone")%></div>
    <div class="shead text-white font-weight-bold">Email </div>
    <div class="shead text-white" name="email"> <%= request.getAttribute("email")%> </div>
    <div class="shead text-white font-weight-bold">LinkedIn </div>
    <div class="shead text-white" name="linkedin"><%= request.getAttribute("linkedin")%></div>
    <div class="spam ">
            <h5 class="text-white "> Skills </h5>
                
        </div>
        <ul class="shead text-white">
                <li name="skil1" ><% if(request.getAttribute("skill")!=null)%><%= request.getAttribute("skil1")%></li>
                <li name="skill2"><% if(request.getAttribute("skill2")!=null)%><%= request.getAttribute("skill2")%></li>
                <li name="skill3"><% if(request.getAttribute("skill3")!=null)%><%= request.getAttribute("skill3")%></li>
                <li name="skill4"><% if(request.getAttribute("skill4")!=null)%><%= request.getAttribute("skill4")%></li>
                <li name="skill5"><% if(request.getAttribute("skill5")!=null)%><%= request.getAttribute("skill5")%></li>
            </ul>
        <div class="spam ">
                <h5 class="text-white "> Languages  Known </h5>
                
                 <ul class="shead text-white">
                <li name="lan1" ><% if(request.getAttribute("lan1")!=null)%><%= request.getAttribute("lan1")%></li>
                <li name="lan2"><% if(request.getAttribute("lan2")!=null)%><%= request.getAttribute("lan2")%></li>
                <li name="lan3"><% if(request.getAttribute("lan3")!=null)%><%= request.getAttribute("lan3")%></li>
                <li name="lan4"><% if(request.getAttribute("lan4")!=null)%><%= request.getAttribute("lan4")%></li>
                <li name="lan5"><% if(request.getAttribute("lan5")!=null)%><%= request.getAttribute("lan5")%></li>
            </ul>
...
<div class="col col-sm-9"> <p class=".lead" name="objective"><% if(request.getAttribute("objective")!=null)%>
